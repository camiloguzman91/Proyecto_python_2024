        ...
        for ship in ships:
            if self.computer:
                ...
                while not placed:
                    ...
                    placed = ship.place_ship(start_row, start_col, direction, self.board)
            else:
                while True:
...
class BattleshipGame:
    def __init__(self):
        self.player1 = Player("Jugador", computer=False)
        self.player2 = Player("Computadora", computer=True)

    def play(self):
        print("Bienvenido al juego de Batalla Naval!")
        print("Jugador, coloca tus barcos.")
        self.player1.place_ships()
        print("Computadora está colocando sus barcos.")
